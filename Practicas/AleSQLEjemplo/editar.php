...
<body>
    <?php
    // Esto es para guardar los datos de proovedores en la array misma
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Su propio creador dice que cojones son resennas, digamos que son precios
    ...
    // Con esto guarda todos los datos que posee el producto a cambiar y lo guarda en la variable $resultado
    ...
    // No se cuando esto seria necesario pero lo que hace es que si no tiene valor, le otorgue "" para que no se rompa el codigo luego
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="categoria_producto" value="<?php echo $producto["categoria_producto"] ?>">
