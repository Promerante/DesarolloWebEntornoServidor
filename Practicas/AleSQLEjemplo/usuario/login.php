...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($res->num_rows == 0) {
            ...
            //var_dump($info_usuario);ALABADO SEA EL VARDUMP FRFRFRF
            // password_verify: verifica si lo que puso el usuario esta en la bbdd,y como esta en HASH
            // la funcion la desencripta y ahi las compara
