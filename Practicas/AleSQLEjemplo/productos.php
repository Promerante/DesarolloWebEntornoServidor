...
<body>
    ...
    //prefiero comprobar lo de admin cada vez en vez de usar otra $_SESSION
    ...
    <div class="container mt-4">
        <h1>Productos</h1>
        <div class="mb-3">
            <!-- Lo toquetea inyectando valores URL, poniendo solo eso parece que lo concatena a la pagina actual-->
