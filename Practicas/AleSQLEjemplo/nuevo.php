...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        //  realmente mete este condicion por si inyectan codigo, no es tan necesario
        ...
        if (!$errores) {
            ...
            if ($_conexion->query($consulta)) {
                ...
                // Esto es mas por si sale error mandando la consulta, te cubres las espaldas y ves mejor el posible error
